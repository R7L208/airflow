...
more details. Note: This feature is still experimental. See `documentation on Executor <https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/executor/index.html#executor>`_ for a more detailed description.
...
- Query count statistics when parsing DAF file (#41149)
